...
- [DB Health Check MySQL](https://github.com/rootdanley/db_healthcheck_mysql) — automação para coleta e análise de informações de ambientes MySQL.
- [API de Pagamentos](https://github.com/rootdanley/awpag-api-springboot) — API desenvolvida com Java e Spring Boot.
- [Spring Boot OAuth2 JWT](https://github.com/rootdanley/spring-boot-oauth2-jwt) — implementação de autenticação e autorização com OAuth2 e JWT.
- [Traffic API](https://github.com/rootdanley/traffic-api-springboot) — API REST desenvolvida com Spring Boot.
